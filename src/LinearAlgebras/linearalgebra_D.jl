...
#C = A'*B
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,nw,DI}
...
#C = α*A'*B+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},
...
#C = A*B'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,nw,DI}
...
#C = α* A*B' + β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,nw,S<:Number,DI}
...
#C = A'*B'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,nw,DI}
    JACC.parallel_for(
...
#C =  α* A'*B' + β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,nw,S<:Number,DI}
    JACC.parallel_for(
...
function substitute!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI}, A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC2,nw,DI}}) where {D,T1,T2,AT1,AT2,NC1,NC2,nw,DI}
    JACC.parallel_for(
...
function substitute!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI}, A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC2,nw,DI},shift}) where {D,T1,T2,AT1,AT2,NC1,NC2,shift,nw,DI}
    JACC.parallel_for(
...
function substitute!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI}, A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC2,nw,DI},shift}}) where {D,T1,T2,AT1,AT2,NC1,NC2,shift,nw,DI}
    JACC.parallel_for(
...
#C = shiftedA*B
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shift}, B::LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α shiftedA*B + β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shift}, B::LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = A*shiftedB
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shift}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α A*shiftedB + β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shift},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
    βin = T1(β)
    αin = T1(α)
    JACC.parallel_for(
...
#C = shiftedA'*B
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shift}}, B::LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α*shiftedA'*B + β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shift}}, B::LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = shiftedA*B'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shift}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α*shiftedA*B'+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shift}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = shiftedA'*B'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shift}}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}

    JACC.parallel_for(
        prod(C.PN), kernel_Dmatrix_mul_shiftAdagBdag!, C.A, A.data.data.A, B.data.A, Val(NC1), Val(NC2), Val(NC3), Val(nw), C.indexer, shift
    )
    #set_halo!(C)
end
...
#C = α*shiftedA'*B'+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shift}}, B::Adjoint_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = A'*shiftedB
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shift}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α*A'*shiftedB+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shift},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = A*shiftedB'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI}, B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shift}}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α*A*shiftedB'+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI}, B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shift}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = A'*shiftedB'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shift}}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,DI}
...
#C = α*A'*shiftedB'+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI}}, B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shift}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shift,nw,S<:Number,DI}
...
#C = shiftA*shiftedB
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shiftA}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shiftB}) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shiftA,shiftB,nw,DI}
...
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shiftA}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shiftB},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,AT3,NC1,NC2,NC3,shiftA,shiftB,nw,S<:Number,DI}
...
#C = shiftA'*shiftedB
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shiftA}}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shiftB}) where {D,T1,T2,T3,AT1,AT2,
...
#C = α*shiftA'*shiftedB+β*C
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shiftA}}, B::Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC3,NC2,nw,DI},shiftB},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,
    AT3,NC1,NC2,NC3,shiftA,shiftB,nw,S<:Number,DI}
...
#C = shiftA*shiftedB'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shiftA},
    B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shiftB}}) where {D,T1,T2,T3,AT1,AT2,
    AT3,NC1,NC2,NC3,shiftA,shiftB,nw,DI}
...
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC1,NC3,nw,DI},shiftA},
    B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shiftB}},
    α::S, β::S) where {D,T1,T2,T3,AT1,AT2,
    AT3,NC1,NC2,NC3,shiftA,shiftB,nw,S<:Number,DI}
...
#C = shiftA'*shiftedB'
function LinearAlgebra.mul!(C::LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},
    A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T2,AT2,NC3,NC1,nw,DI},shiftA}},
    B::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T3,AT3,NC2,NC3,nw,DI},shiftB}}) where {D,T1,T2,T3,AT1,AT2,
    AT3,NC1,NC2,NC3,shiftA,shiftB,nw,DI}
...
#C = C+ α*shiftA
function add_matrix!(C::LatticeMatrix{D,T,AT,NC1,NC2,nw,DI}, A::Shifted_Lattice{LatticeMatrix{D,T1,AT1,NC1,NC2,nw,DI},shift}, α::S=1) where {D,T,T1,AT,AT1,NC1,NC2,shift,nw,S<:Number,DI}
...
#C = C+ α*Adag
function add_matrix!(C::LatticeMatrix{D,T,AT,NC1,NC2,nw,DI}, A::Adjoint_Lattice{LatticeMatrix{D,T1,AT1,NC2,NC1,nw,DI}}, α::S=1) where {D,T,T1,AT,AT1,NC1,NC2,nw,S<:Number,DI}
...
#C = C+ α*shiftAdag
function add_matrix!(C::LatticeMatrix{D,T,AT,NC1,NC2,nw,DI}, A::Adjoint_Lattice{Shifted_Lattice{LatticeMatrix{D,T1,AT1,NC2,NC1,nw,DI},shift}}, α::S=1) where {D,T,T1,AT,AT1,NC1,NC2,shift,nw,S<:Number,DI}
